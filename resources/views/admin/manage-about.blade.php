                            ...
                            <tbody>
                                @foreach ($cms as $index => $item)
                                    <tr>
                                        ...
                                        <td>{{ \Illuminate\Support\Str::words(strip_tags($item->content), 15, '[...]') }}
                                        </td>
                                        <td>
